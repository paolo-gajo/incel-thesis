...
for df_index in range(3):
    df_filename = f'/home/pgajo/working/incels/data/datasets/English/Incels.is/ECIR/IFD-EN-5203_truncated_{df_index}.tsv'
    df = pd.read_csv(df_filename,
                     sep='\t',
                    #  nrows=100,
                     )
    df_original_filename = f'/home/pgajo/working/incels/data/datasets/English/Incels.is/ECIR/IFD-EN-5203_truncated_0.tsv'
    df_original = pd.read_csv(df_original_filename, sep='\t')
    ...
    df_test = df_original[df_original['data_type'] == 'test_incelsis']
    df_test_source = df_original_filename.split('/')[-1]
    ...
    for i in range(1):
        # Filename bits
        metrics_path_category = f'/home/pgajo/working/incels/results/ECIR_{experiment_name}/metrics_truncated_{df_index}'
