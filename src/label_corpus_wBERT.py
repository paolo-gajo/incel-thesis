...
model_name = "/home/pgajo/working/pt_models/incel-bert-base-uncased-1000k_english_finetuned1_hate_speech_metrics_id_0"
...
input_csv = "/home/pgajo/working/data/datasets/English/Incels.is/IFC-22-EN_updated.csv"
output_csv = os.path.splitext(input_csv)[0] + "_hs_silver_labels" + os.path.splitext(input_csv)[1]
chunksize = 16  # You can adjust this number based on your machine's memory

first_chunk = True
for chunk in tqdm(pd.read_csv(input_csv, chunksize=chunksize), total=pd.read_csv(input_csv).shape[0]//chunksize):
