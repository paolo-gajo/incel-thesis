...
df_fdb_500 = pd.read_csv(
    '/home/pgajo/working/incels/data/datasets/Italian/Il_forum_dei_brutti/IFD-IT-500.csv')
...
file_path_csv_davidson = '/home/pgajo/working/incels/data/datasets/English/hate-speech-and-offensive-language (davidson)/davidson_labeled_data.csv'
...
file_path_csv_hateval_2019_english_train = '/home/pgajo/working/incels/data/datasets/English/hateval2019_en/hateval2019_en_train_miso.csv'
file_path_csv_hateval_2019_english_dev = '/home/pgajo/working/incels/data/datasets/English/hateval2019_en/hateval2019_en_dev_miso.csv'
file_path_csv_hateval_2019_english_test = '/home/pgajo/working/incels/data/datasets/English/hateval2019_en/hateval2019_en_test_miso.csv'
...
file_path_csv_hateval_2019_spanish_train = '/home/pgajo/working/incels/data/datasets/Spanish/hateval2019_es/hateval2019_es_train.csv'
file_path_csv_hateval_2019_spanish_dev = '/home/pgajo/working/incels/data/datasets/Spanish/hateval2019_es/hateval2019_es_dev.csv'
file_path_csv_hateval_2019_spanish_test = '/home/pgajo/working/incels/data/datasets/Spanish/hateval2019_es/hateval2019_es_test.csv'
...
filename_json = '/home/pgajo/working/incels/data/datasets/English/HateXplain/Data/dataset.json'
...
df_stormfront_raw = pd.read_csv(
    '/home/pgajo/working/incels/data/datasets/English/hate-speech-dataset-stormfront/annotations_metadata.csv')
df_stormfront_raw['label'] = df_stormfront_raw['label'].replace(
    {'noHate': 0, 'hate': 1})
df_stormfront_raw = df_stormfront_raw.rename(columns={'label': 'hs'})

post_dir = '/home/pgajo/working/incels/data/datasets/English/hate-speech-dataset-stormfront/all_files'
dict_ids_labels = {}
dict_post_pairs_ws = []
...
for j in range(26, 33):
    ...
    if 'dev_evalita18facebook' in metrics_list_names[metrics_id][1]:
        df_dev = pd.concat([df_dev, df_dev_evalita18facebook])

    if 'dev_evalita18twitter' in metrics_list_names[metrics_id][1]:
        df_dev = pd.concat([df_dev, df_dev_evalita18twitter])
    ...
    for model_name in model_name_list:
        for i in range(5):
            ...
            metrics_save_path = f'{metrics_path_category}/metrics_italian/'
